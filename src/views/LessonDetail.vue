...
// Use computed to get current route params (they can change when navigating between lessons)
...
onMounted(async () => {
  ...
  if (lesson.value) {
    ...
    // Initialize audio for this lesson
    initializeAudio(lesson.value, currentLearning, currentTeaching, settings.value)
  }
})
